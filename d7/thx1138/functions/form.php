...
function thx1138_form($variables) {
...
adds form-required
*/
function thx1138_form_element($variables) {
  ...
  if(! theme_get_setting('thx1138_classes_form_wrapper_formitem')){
  ...
  if (!empty($element['#type'])) {
    if(!theme_get_setting('thx1138_classes_form_wrapper_formtype')){
      $attributes['class'][] = 'form-type-' . strtr($element['#type'], '_', '-');
    }
  }
  if (!empty($element['#name'])) {
    if(!theme_get_setting('thx1138_classes_form_wrapper_formname')){
  ...
  if($attributes['class']){
    $remove_class_form = explode(", ", theme_get_setting('thx1138_classes_form_freeform'));
  ...
  if (!empty($element['#description'])) {
    ...
    */
    if(!theme_get_setting('thx1138_classes_form_description')){
...
*/
function thx1138_form_element_label($variables) {
  $element = $variables['element'];
  ...
  if(!theme_get_setting('thx1138_form_required')){
...
//       $attributes['class'] = 'form-field-required';
  ...
  if ($element['#title_display'] == 'after') {
    if(!theme_get_setting('thx1138_classes_form_label')){
  ...
  if (!empty($element['#id'])){
    ...
    if(
      ...
      theme_get_setting('thx1138_html5') AND
      $element['#type'] != "item" &&
...
*/
function thx1138_textfield($variables) {
  $element = $variables['element'];
  $element['#size'] = '30';
  ...
  $element['#attributes']['type'] = 'text';
	...
	//placeholder
  if (!empty($element['#title']) AND theme_get_setting('thx1138_classes_form_placeholder_label') ) {
  ...
  if(!theme_get_setting('thx1138_classes_form_input')){
...
function thx1138_link_field($vars) {
  ...
  if (empty($element['#field']['multiple'])) {
	...
	//placeholder
	if( theme_get_setting('thx1138_classes_form_placeholder_link') ){
    $element['#attributes']['placeholder'] = theme_get_setting('thx1138_classes_form_placeholder_link');
	}
	elseif (!empty($element['#title']) AND theme_get_setting('thx1138_classes_form_placeholder_label') ) {
   $element['#attributes']['placeholder'] = $element['#title'];
  }
...
*/
function thx1138_emailfield($variables) {
  $element = $variables['element'];
  ...
  _form_set_class($element, array('form-text', 'form-email'));
	...
	//placeholder
	if( theme_get_setting('thx1138_classes_form_placeholder_email') ){
    $element['#attributes']['placeholder'] = theme_get_setting('thx1138_classes_form_placeholder_email');
	}
	elseif (!empty($element['#title']) AND theme_get_setting('thx1138_classes_form_placeholder_label') ) {
   $element['#attributes']['placeholder'] = $element['#title'];
  }
...
function thx1138_urlfield($variables) {
  $element = $variables['element'];
...
function thx1138_textarea($variables) {
  $element = $variables['element'];
...
function thx1138_checkbox($variables) {
  $element = $variables['element'];
  $t = get_t();
...
function thx1138_radio($variables) {
  $element = $variables['element'];
...
function thx1138_file($variables) {
  $element = $variables['element'];
//  $element['#size'] = '30';
...
*/
function thx1138_password($variables) {
  $element = $variables['element'];
  $element['#size'] = '30';
...
//  element_set_attributes($element, array('id', 'name',  'maxlength'));
  ...
  if (!empty($element['#description']) AND theme_get_setting('thx1138_classes_form_placeholder_description') ) {
...
/* removed form-select */
function thx1138_select($variables) {
  $element = $variables['element'];
  element_set_attributes($element, array('id', 'name', 'size'));
...
remove form-text class
*/
function thx1138_text_format_wrapper($variables) {
  $element = $variables['element'];
...
function thx1138_button($variables) {
  $element = $variables['element'];
...
remove form-wrapper
*/
function thx1138_fieldset($variables) {
  $element = $variables['element'];
...
function thx1138_container($variables) {
  $element = $variables['element'];
  ...
  if (isset($element['#array_parents'])) {
    ...
    // Add the 'form-wrapper' class.
		if(!theme_get_setting('thx1138_classes_form_container_wrapper')){
    	$element['#attributes']['class'][] = 'form-wrapper';
		}

		//remove the field-type-...  yup this is but ugly
		if(theme_get_setting('thx1138_classes_form_container_type')){
			$element['#attributes']['class']['0'] = "";
		}

		//remove the field-name-field...  yup this is but ugly
		if(theme_get_setting('thx1138_classes_form_container_name')){
			$element['#attributes']['class']['1'] = "";
		}

		//remove the field-widget-....
		if(theme_get_setting('thx1138_classes_form_container_widget')){
			$element['#attributes']['class']['2'] = "";
		}

		//remove the id
		if(theme_get_setting('thx1138_classes_form_container_id')){
...
function thx1138_field_multiple_value_form($variables) {
  $element = $variables['element'];
	$output = '';
...
*/
function thx1138_form_alter(&$form, &$form_state, $form_id) {
/*
	print "<pre>";
	print_r($form_id);
	print_r($form);
...
*/
  ...
  if ($form_id == 'user_login_block') {
	...
	if($form_id == 'user_register_form'){
		//placeholder
		if(theme_get_setting('thx1138_classes_form_placeholder_email')){
			$mail_placeholder = theme_get_setting('thx1138_classes_form_placeholder_email');
		}else{
