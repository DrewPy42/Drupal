...
function thx1138_blockify_logo($variables) {
 ...
 * @ingroup themeable
 */
function thx1138_blockify_site_name($variables) {
 ...
 * @ingroup themeable
 */
function thx1138_blockify_site_slogan($variables) {
 ...
 */
// remove the  id & title 
function thx1138_blockify_page_title($variables) {
 ...
 * @ingroup themeable
 */
function thx1138_blockify_breadcrumb($variables) {
...
function thx1138_blockify_local_actions($variables) {
 ...
 * @ingroup themeable
 */
function thx1138_blockify_feed_icons($variables) {
 ...
 */
 ...
 //removed the clearfix
function thx1138_blockify_menu_local_tasks($variables) {
