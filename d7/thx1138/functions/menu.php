...
function thx1138_menu_tree($variables) {
  if(theme_get_setting('thx1138_classes_menu_wrapper')){
...
*/
function thx1138_menu_link(array $variables) {
  //clean up the classes

  //  $remove = array('first','last','leaf','collapsed','expanded','expandable');
  $remove = array();
  if(theme_get_setting('thx1138_classes_menu_items_firstlast')){
    $remove[] .= "first";
    $remove[] .= "last";
  }
  if(theme_get_setting('thx1138_classes_menu_leaf')){
    $remove[] .= "leaf";
  }
  if(theme_get_setting('thx1138_classes_menu_collapsed')){
    $remove[] .= "collapsed";
    $remove[] .= "expanded";
    $remove[] .= "expandable";
  }

  if(theme_get_setting('thx1138_classes_menu_items_active')){
    $remove[] .= "active-trail";
    $remove[] .= "active";
  }
  ...
  if(!empty($variables['element']['#attributes']['class'])){
    ...
    if(theme_get_setting('thx1138_classes_menu_items_mlid')){
    ...
    if(theme_get_setting('thx1138_classes_menu_items')){
...
function thx1138_pager($variables) {
...
function thx1138_views_mini_pager($vars) {
  global $pager_page_array, $pager_total;
...
function thx1138_item_list($variables) {
